                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                        <div>
                            ...
                            <h1 className="font-heading text-3xl font-bold">MarketingCloud<span className="text-primary">AI</span></h1>
                            <p className="text-muted-foreground">Live performance view for TechCorp Inc.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <StatCard title="Total Traffic" value="16,800" change="+34%" icon={Users} delay={0.1} />
                        <StatCard title="Keywords Ranked" value="1,100" change="+12%" icon={TrendingUp} delay={0.2} />
                        <StatCard title="Impressions" value="245k" change="+28%" icon={Eye} delay={0.3} />
                        <StatCard title="CTR" value="6.8%" change="+1.2%" icon={MousePointer} delay={0.4} />
                    </div>
