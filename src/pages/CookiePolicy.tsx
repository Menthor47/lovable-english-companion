                    ...
                    <div className="max-w-3xl mx-auto prose prose-invert prose-headings:font-heading">
                        <div className="space-y-12">
                                    ...
                                    {section.subsections && (
                                        <div className="grid md:grid-cols-2 gap-4 mt-6">
                                            {section.subsections.map((sub, sIdx) => (
                                                <div key={sIdx} className="bg-card border border-border rounded-lg p-6 hover:border-primary/30 transition-colors">
                            ...
                            <div className="pt-8 border-t border-border">
                                <h2 className="text-2xl font-bold text-foreground mb-4">Detailed Cookie Declaration</h2>
                                <p className="text-muted-foreground leading-relaxed mb-6">
                                    Below is a summary of the cookies we use and their purpose. For a complete list or to change your preferences, please use the Cookie Preferences icon at the bottom left of your screen.
                                </p>
                                <div className="space-y-6">
                                    <div className="bg-card border border-border rounded-xl p-6">
                                        ...
                                        <p className="text-sm text-muted-foreground mb-4">Essential for the security and basic functionality of the site. They cannot be disabled.</p>
                                        <ul className="text-xs text-muted-foreground space-y-2 opacity-70">
                                            <li>• silktideCookieChoice_*: Stores your consent preferences.</li>
                                            <li>• session_id: Maintains your session for security.</li>
                                        </ul>
                                    </div>
                                    <div className="bg-card border border-border rounded-xl p-6">
                                        <h3 className="text-lg font-bold text-foreground mb-3 flex items-center gap-2">
                                        ...
                                        <p className="text-sm text-muted-foreground mb-4">Help us understand how you use our site so we can improve the experience.</p>
                                        <ul className="text-xs text-muted-foreground space-y-2 opacity-70">
                                            <li>• _ga, _ga_*: Google Analytics identifiers.</li>
                                            <li>• dataLayer: Used for tracking events and performance.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
