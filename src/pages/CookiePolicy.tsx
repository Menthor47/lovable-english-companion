                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto prose prose-invert prose-headings:font-heading">
                        <div className="space-y-12">
                            ...
                            {/* Dynamic Cookiebot Declaration - Auto-syncs with Cookiebot Dashboard */}
                            <div className="space-y-4 pt-8 border-t border-border">
                                <h2 className="text-2xl font-bold text-foreground">Cookie Declaration</h2>
                                <p className="text-muted-foreground leading-relaxed">
                                    The following is automatically generated by our consent management platform to reflect the current cookies in use:
                                </p>
                                <div
                                    ...
                                    ref={(el) => {
                                        if (el && !el.querySelector('script')) {
                                            ...
                                            script.src = 'https://consent.cookiebot.com/63e60d70-645d-453b-8830-f34d50e374c7/cd.js';
                                            script.async = true;
